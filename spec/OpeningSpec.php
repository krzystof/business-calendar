...
class OpeningSpec extends ObjectBehavior
{
    ...
    public function it_returns_the_open_at_and_close_at_times()
    {
    ...
    public function it_overlaps_when_an_opening_opens_during_its_timeframe()
    {
    ...
    public function it_doesnt_overlaps_when_an_opening_starts_after_its_timeframe()
    {
    ...
    public function it_overlaps_when_an_opening_is_contained_in_its_timeframe()
    {
    ...
    public function it_overlaps_when_an_opening_starts_the_day_before_and_closes_in_its_timeframe()
    {
    ...
    public function it_overlaps_when_an_opening_covers_its_timeframe()
    {
    ...
    public function it_overlaps_when_an_opening_start_during_the_previous_week_and_closes_during_its_timeframe()
    {
    ...
    public function it_overlaps_when_an_opening_start_during_the_previous_week_and_closes_after_its_timeframe()
    {
    ...
    public function it_is_invalid_when_the_length_exceeds_a_week()
    {
        $this->beConstructedWith([
            'day' => Carbon::MONDAY,
            'time' => '08:00',
